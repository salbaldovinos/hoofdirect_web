...
export const SEO = {
  ...
  ogImage: '/images/og-image.png', // To be added
};
...
// Pricing tiers (for reference - may be used on page)
export const PRICING = {
  ...
  foundingDiscount: 20, // percent
  annualDiscount: 20, // percent
};
...
// External links (update these as needed)
export const LINKS = {
  mailchimpForm: process.env.NEXT_PUBLIC_MAILCHIMP_URL || '#',
  playStore: '#', // Will be added when app launches
  twitter: '#', // Update with actual Twitter/X handle
  facebook: '#', // Update if using
};
